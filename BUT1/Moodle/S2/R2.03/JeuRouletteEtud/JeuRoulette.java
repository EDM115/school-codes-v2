/**
 * Jeu de la roulette : le joueur parie sur 1 case de la roulette de Casino. Ensuite la roulette
 * tourne et si la bille tombe sur la case choisie par le joueur, le jeu s'arrête.
 */
public class JeuRoulette {
  ...
  public static void main(String[] args) {
    ...
    // ToDo : boucle automatique de jeu et sortir dès que la bille tombe sur la bonne case (sur
    // laquelle le joueur a parié).
    // 1. appeler tournerRoulette de la classe Roulette
    // 2. capturer obligatoirement l'exception "Aleatoire" et récupérer l'entier aléatoire de
    // l'objet (de type Aleatoire) avec l'accesseur
