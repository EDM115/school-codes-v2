...
void lv_example_chart_2 (void) {
  ...
  lv_chart_set_div_line_count (chart2, 5, 7);
  ...
  lv_timer_create (add_data_2, 200, NULL);
}
...
static void draw_event_cb_3 (lv_event_t *e) {
  ...
  if (dsc->id == LV_CHART_AXIS_PRIMARY_X && dsc->text) {
    const char *month[] = {
      "Jan", "Febr", "March", "Apr", "May", "Jun", "July", "Aug", "Sept", "Oct", "Nov", "Dec"
    };
...
static void event_cb_4 (lv_event_t *e) {
...
void lv_example_chart_4 (void) {
  ...
  lv_obj_add_event_cb (chart, event_cb_4, LV_EVENT_ALL, NULL);
...
static void event_cb_6 (lv_event_t *e) {
...
void lv_example_chart_6 (void) {
  ...
  lv_obj_add_event_cb (chart6, event_cb_6, LV_EVENT_ALL, NULL);
...
static void draw_event_cb_7 (lv_event_t *e) {
...
static void add_data_7 (lv_timer_t *timer) {
...
void lv_example_chart_7 (void) {
  ...
  lv_obj_add_event_cb (chart, draw_event_cb_7, LV_EVENT_DRAW_PART_BEGIN, NULL);
  ...
  lv_timer_create (add_data_7, 100, chart);
}
 ...
 **/
static void draw_event_cb_8 (lv_event_t * e) {
...
void lv_example_chart_8 (void) {
  ...
  lv_obj_add_event_cb (stacked_area_chart.obj, draw_event_cb_8, LV_EVENT_DRAW_PART_BEGIN, NULL);
