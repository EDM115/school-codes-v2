...
public class SimplesTableau {
  ...
  void testVerifTab() {
    ...
    System.out.println(
        "=== Cas normal : le nombre d'\u00e9l\u00e9ments d\u00e9passe la taille ===");
    ...
    System.out.println(
        "=== Cas limite : le nombre d'\u00e9l\u00e9ments est \u00e9gale \u00e0 z\u00e9ro ===");
  ...
  void testAfficherTab() {
    ...
    System.out.println(
        "=== Cas d'erreur : le nombre d'\u00e9l\u00e9ments n'est pas dans les bornes ===");
  ...
  void testEgalite() {
    ...
    System.out.println(
        "\n"
            + "Cas o\u00f9 l'\u00e9galit\u00e9 est fausse : nombre d'\u00e9l\u00e9ments"
            + " diff\u00e9rent");
  ...
  void testSupprimerUneValeur() {
    ...
    System.out.println("Contenu du tableau :");
    this.afficherTabLgn(array, n, 4);
    final int supprimerUneValeur =
        this.supprimerUneValeur(array, n, SimpleInput.getInt("Entrer une valeur \u00e0 supprimer"));
    ...
    while (i > 0) {
      i =
          this.supprimerUneValeur(
              array2, i, SimpleInput.getInt("Entrer une valeur \u00e0 supprimer"));
      System.out.println("Contenu du tableau apr\u00e8s suppression :");
      this.afficherTabLgn(array2, i, 4);
    }
