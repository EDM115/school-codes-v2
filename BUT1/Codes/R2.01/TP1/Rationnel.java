...
public class Rationnel {
	...
	public Rationnel ajoute(Rationnel r) {
		...
		if (r != null) {
			int newNumerateur = this.numerateur * r.getDenominateur() + this.denominateur * r.getNumerateur();
	...
	public Boolean egale(Rationnel r) {
		...
		if (r != null) {
			equal = ((this.numerateur == r.getNumerateur()) && (this.denominateur == r.getDenominateur()));
		}
