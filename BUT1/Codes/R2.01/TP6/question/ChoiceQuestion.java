...
/**
 * ChoiceQuestion class (extends Question), represents a question with a text, an answer and a list of choices
 */
public class ChoiceQuestion extends Question {
	...
	/**
	 * Default constructor, initializes the question, the answer and the list of choices to empty strings
	 */
