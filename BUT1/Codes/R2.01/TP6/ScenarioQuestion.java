...
public class ScenarioQuestion {
	...
	public static void main(String[] args) {
		...
		System.out.println("Question(\"Quelle est la couleur du cheval blanc d'Henri IV ?\", \"blanc\") -> " + question1);
		Question question2 = new Question("Comment s'appelle le chat roux dans Garfield ?", "garfield");
		System.out.println("Question(\"Comment s'appelle le chat roux dans Garfield ?\", \"garfield\") -> " + question2);
		Question question3 = new Question("Quelle est la capitale du Honduras ?", "tegucigalpa");
		System.out.println("Question(\"Quelle est la capitale du Honduras ?\", \"tegucigalpa\") -> " + question3);
		...
		System.out.println("question5.setText(\"En quelle année a été crée GitHub ?\") -> " + question5.getText());
		...
		System.out.println("choiceQuestion1.addChoice(\"How To Meet Ladies\", false) -> " + choiceQuestion1);
		choiceQuestion1.addChoice("Hyper Text Markup Language", true);
		System.out.println("choiceQuestion1.addChoice(\"Hyper Text Markup Language\", true) -> " + choiceQuestion1);
		choiceQuestion1.addChoice("Huge Thing Making Lava", false);
		System.out.println("choiceQuestion1.addChoice(\"Huge Thing Making Lava\", false) -> " + choiceQuestion1);
		choiceQuestion1.addChoice("Happy Time Making Lemonade", false);
		System.out.println("choiceQuestion1.addChoice(\"Happy Time Making Lemonade\", false) -> " + choiceQuestion1);

		choiceQuestion2.addChoice("Globally Organized Online Group Location Engine", false);
		System.out.println("choiceQuestion2.addChoice(\"Globally Organized Online Group Location Engine\", false) -> " + choiceQuestion2);
		choiceQuestion2.addChoice("Global Organization of Oriented Group Language of Earth", false);
		System.out.println("choiceQuestion2.addChoice(\"Global Organization of Oriented Group Language of Earth\", false) -> " + choiceQuestion2);
		choiceQuestion2.addChoice("Tire ses origines du nombre Gogol", true);
		System.out.println("choiceQuestion2.addChoice(\"Tire ses origines du nombre Gogol\", true) -> " + choiceQuestion2);
		...
		System.out.println("choiceQuestion3.addChoice(\"Léonard de Vinci\", false) -> " + choiceQuestion3);
