...
public class ScenarioPromotion {
	...
	public static void main(String[] args) {
		...
		System.out.println("Promo Info 2023 -> moyenneMatiere(" + matieres[0] + ") = " + promo.moyenneMatiere(0));
		System.out.println("Promo Info 2023 -> moyenneMatiere(" + matieres[1] + ") = " + promo.moyenneMatiere(1));
		System.out.println("Promo Info 2023 -> moyenneMatiere(" + matieres[2] + ") = " + promo.moyenneMatiere(2));
