  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Etudiant("
            + nom1
            + ", "
            + Arrays.toString(matieres1)
            + ", "
            + Arrays.toString(coeff1)
            + ", "
            + nb1
            + ") = \n"
            + etudiant1.toString());
    ...
    System.out.println(
        "Etudiant("
            + nom2
            + ", "
            + Arrays.toString(matieres2)
            + ", "
            + Arrays.toString(coeff2)
            + ", "
            + nb2
            + ") = \n"
            + etudiant2.toString());
    ...
    System.out.println(
        "Etudiant("
            + nom3
            + ", "
            + Arrays.toString(matieres3)
            + ", "
            + Arrays.toString(coeff3)
            + ", "
            + nb3
            + ") = \n"
            + etudiant3.toString());
    ...
    System.out.println(
        Arrays.toString(etudiant1.getBulletin()[1])
            + " -> getUneNote(1, 3) = "
            + etudiant1.getUneNote(1, 3));
    System.out.println(
        Arrays.toString(etudiant1.getBulletin()[2])
            + " -> getUneNote(2, 3) = "
            + etudiant1.getUneNote(2, 3));
    System.out.println(
        "etudiant1.getBulletin()[3] -> getUneNote(3, 3) = " + etudiant1.getUneNote(3, 3));
    System.out.println(
        Arrays.toString(etudiant1.getBulletin()[0])
            + " -> getUneNote(0, -1) = "
            + etudiant1.getUneNote(0, -1));
    ...
    System.out.println(
        Arrays.toString(etudiant1.getBulletin()[0])
            + " -> moyenneMatiere(0) = "
            + etudiant1.moyenneMatiere(0));
    System.out.println(
        Arrays.toString(etudiant2.getBulletin()[1])
            + " -> moyenneMatiere(1) = "
            + etudiant2.moyenneMatiere(1));
    System.out.println(
        Arrays.toString(etudiant3.getBulletin()[2])
            + " -> moyenneMatiere(2) = "
            + etudiant3.moyenneMatiere(2));

    System.out.println("");
    System.out.println("\u001B[36m*** moyenneGenerale()\u001B[0m");
    System.out.println(
        etudiant1.betterBulletin(etudiant1.getBulletin())
            + " -> moyenneGenerale() = "
            + etudiant1.moyenneGenerale());
    System.out.println(
        etudiant2.betterBulletin(etudiant2.getBulletin())
            + " -> moyenneGenerale() = "
            + etudiant2.moyenneGenerale());
    System.out.println(
        etudiant3.betterBulletin(etudiant3.getBulletin())
            + " -> moyenneGenerale() = "
            + etudiant3.moyenneGenerale());
