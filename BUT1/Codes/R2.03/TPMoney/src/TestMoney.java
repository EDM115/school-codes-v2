...
public class TestMoney {
	...
	public void testAdd() {
		...
		IMoney res = this.m.add(new Money(5, "EUR"));
	...
	public void testAddDevise() {
		...
		IMoney res = this.m.add(new Money(5, "USD"));
		assertNotEquals("\u001B[31mECHEC du test : devise incorrecte", m.getCurrency(), res.getCurrency());
		System.out.println("\u001B[32mTest réussi\u001B[0m");
	}
