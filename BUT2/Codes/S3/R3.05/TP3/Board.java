 ...
 * Elle contient en particulier une liste de toutes les collisions d'un
 * rectangle avec un autre.
 * 
...
public abstract class Board extends JPanel {
    ...
    private final Map<Integer, Rectangle> occupiedPixels = new HashMap<>();
    ...
    /**
     * Indication sur les type de collisions :
     * <ul>
     * <li>No : sans collision</li>
     * <li>Collision : temporaire (qui peut être résolue en attendant que la place
     * soit libre)</li>
     * <li>DeadLock : impossibilité de mouvement qui impose de changer la
     * trajectoire</li>
     * </ul>
     */
    public enum CollisionType {
        No, Collision, DeadLock;
    }

    /**
     * Liste les composants en collision avec un autre élément.
     */
    Hashtable<Component, ArrayList<Component>> allCollisions = new Hashtable<Component, ArrayList<Component>>();
    ...
    public CollisionType canMove(Component mobile, Point pos) {
        ...
        if (collisions.size() == 0) {
            if (mobile instanceof ColoredRectangle) {
                ColoredRectangle rectangle = (ColoredRectangle) mobile;
                occupiedPixels.put(rectangle.getId(), new Rectangle(pos, mobile.getSize()));
            }
