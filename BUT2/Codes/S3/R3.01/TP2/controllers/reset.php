<?php
	...
	echo "<br><h2 class=\"drac-heading drac-heading-lg drac-text-purple\"> Réinitialisation </h2><br><br><span class=\"drac-text drac-line-height drac-text-white\"> La base de données à bien été réinitialisée</span>";
