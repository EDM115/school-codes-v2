...
CalculDistance.prototype.R = 6378.137;
...
CalculDistance.prototype.calculDistanceTrajet = function(activityObject) {
...
let distanceCalculator = new CalculDistance();
console.log(`La distance du trajet est de: ${distanceCalculator.calculDistanceTrajet(activity)} km`);
