...
/**
   Rectangle de couleur affiché dans un panneau. Les rectangles ont comme caractéristiques :<ul>
   <li>une couleur</li>
   <li>une position</li>
   <li>une taille</li>
   ...
   Ce sera à vous d'en faire un objet mobile et autonome dans la classe dérivée "Mobile".
...
public class ColoredRectangle extends JLabel {
    ...
    */
    ...
    /**
       proposition de nouvelle position en fonction de la vitesse et des dimension du panneau.
