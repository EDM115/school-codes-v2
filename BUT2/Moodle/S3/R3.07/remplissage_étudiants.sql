...
INSERT ALL
	INTO Operation VALUES (1, SYSDATE-2,'RETRAIT', 10, 2, 1)
	INTO Operation VALUES (2, SYSDATE-3,'RETRAIT', 3000, 3, 2) 
	INTO Operation VALUES (3, SYSDATE-4,'DEPOT', 50, 3, 3) 
	INTO Operation VALUES (4, SYSDATE-4,'DEPOT', 200, 4, 4) 
	INTO Operation VALUES (5, SYSDATE-1, 'RETRAIT', 10000, 6, 5)
	INTO Operation VALUES (6, SYSDATE-1, 'RETRAIT', 40, 7, 6)
	INTO Operation VALUES (7, SYSDATE-1, 'DEPOT', 10000, 7, 7) 
	INTO Operation VALUES (8, SYSDATE-2, 'RETRAIT', 100, 9, 8) 
	INTO Operation VALUES (9, SYSDATE-2, 'DEPOT', 400, 9, 9) 
	INTO Operation VALUES (10, SYSDATE-3, 'DEPOT', 500, 10, 10) 
	INTO Operation VALUES (11, SYSDATE-3, 'RETRAIT', 600, 12, 11)
	INTO Operation (numOperation, typeOperation, montant, leClient, leCompte) VALUES (12, 'RETRAIT', 700, 13, 12)
	INTO Operation (numOperation, typeOperation, montant, leClient, leCompte) VALUES (13, 'DEPOT', 750, 13, 13) 
SELECT * FROM DUAL
;
