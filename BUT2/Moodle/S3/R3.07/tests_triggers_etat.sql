...
INSERT INTO Agence(numAgence,telAgence,adAgence) VALUES (101, '0123456789', 'Issy');
INSERT INTO Agent VALUES(100,'Chevet','Anatole',2000,1,1) -- Ne sera pas inséré (deuxième directeur);
INSERT INTO Agent VALUES(200,'Fouquet','Damien',2000,0,4);
INSERT INTO Agent VALUES(300,'Faria','Jean',2000,0,4);
INSERT INTO Agent VALUES(400,'Charles','Michèle',4000,1,4) -- Ne sera pas inséré (deuxième directeur);
INSERT INTO Agent VALUES(500,'De Santa','Michel',2000,0,100) -- Ne sera pas inséré (pas de directeur);
INSERT INTO Agent VALUES(500,'De Santa','Michel',4000,1,101);
INSERT INTO Agent VALUES(600,'De Santa','Marcel',2000,0,101);
...
INSERT ALL
	INTO Agent VALUES(36,'Belmouhcine','Abdelbadie',5000,0,1) -- Ne sera pas inséré (employé mieux payé que son directeur)
    INTO Agent VALUES(45,'Le Brazidec','Albert',1900,0,1)
	INTO Agent VALUES(50,'Benoit','Thome',6000,0,2) -- Ne sera pas inséré (employé mieux payé que son directeur)
SELECT * FROM DUAL;